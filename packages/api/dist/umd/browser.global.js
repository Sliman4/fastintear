    ...
    async signIn({
      ...
      return new Promise((resolve, reject) => {
        ...
        const hotConnectorOrigin = new Promise((resolve2) => {
          ...
          const listener2 = /* @__PURE__ */ __name((event2) => {
            if (event2.data.origin) {
              origin = event2.data.origin;
          ...
          switch (event2.data.type) {
            ...
            case "connected": {
              ...
              const dataToSave = {
                ...
                logoutKey,
                networkId,
                walletUrl: event2.data.walletUrl,
                useBridge
              };
              console.log("dataToSave", dataToSave, "event.data", event2.data);
